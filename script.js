...
// --- HELPER FOR SPIKES ---
// Adds floor spikes for a range
function floorSpikes(start, count) {
    let arr = [];
    for(let i=0; i<count; i++) arr.push({x: start + i, y: 0, t: 2});
    return arr;
}
...
const LEVELS = [
    ...
    [
        ...
        {x: 100, y: 4, t: 3}, // SHIP
        // Floor Spikes to prevent cheating
        ...floorSpikes(110, 10),
        {x: 120, y: 9, t: 1}, {x: 130, y: 8, t: 1},
        {x: 150, y: 2, t: 1}, {x: 160, y: 3, t: 1},
    ...
    [
        ...
        {x: 100, y: 5, t: 3}, // SHIP
        ...floorSpikes(105, 15), // Spikes underneath ship
        {x: 120, y: 3, t: 1}, {x: 140, y: 6, t: 1}, {x: 160, y: 2, t: 1},

        {x: 190, y: 0, t: 4}, // CUBE
        {x: 200, y: 0, t: 2}, {x: 201, y: 0, t: 2}, {x: 202, y: 0, t: 2},
        {x: 220, y: 1, t: 1}, {x: 230, y: 2, t: 1}, {x: 240, y: 3, t: 1},
        {x: 260, y: 0, t: 2}
    ],
    ...
    [
        ...
        {x: 25, y: 0, t: 1}, {x: 25, y: 1, t: 2},
        
        {x: 40, y: 0, t: 5}, // BALL
        {x: 50, y: 0, t: 1}, {x: 60, y: 7, t: 1},
        {x: 70, y: 0, t: 2}, {x: 80, y: 7, t: 2},
        
        {x: 100, y: 0, t: 4}, // CUBE
        ...floorSpikes(110, 5), // Don't fall!
        {x: 110, y: 2, t: 1}, {x: 120, y: 3, t: 1}, {x: 130, y: 5, t: 1},
    ...
    [
        ...
        {x: 70, y: 4, t: 3}, // SHIP
        ...floorSpikes(75, 20), // Long dangerous ship section
        {x: 90, y: 1, t: 1}, {x: 90, y: 8, t: 1},
        {x: 110, y: 2, t: 1}, {x: 110, y: 7, t: 1},
        {x: 130, y: 1, t: 1}, {x: 130, y: 6, t: 1},
        
        {x: 160, y: 0, t: 4}, // CUBE
        {x: 170, y: 0, t: 1}, {x: 180, y: 2, t: 1}, {x: 190, y: 0, t: 2}
    ],
    ...
    [
        ...
        {x: 120, y: 0, t: 4}, // CUBE - High Platforming
        ...floorSpikes(120, 20), // Floor is LAVA
        {x: 130, y: 2, t: 1}, {x: 140, y: 3, t: 1}, {x: 150, y: 4, t: 1},
        {x: 165, y: 4, t: 2}, {x: 175, y: 2, t: 1}, {x: 190, y: 0, t: 1} // Safety block at end
    ],
    ...
    [
        ...
        {x: 160, y: 3, t: 1}, {x: 180, y: 6, t: 1},
        
        {x: 210, y: 0, t: 4}, // CUBE
        {x: 220, y: 0, t: 1}, {x: 230, y: 2, t: 1}, {x: 240, y: 4, t: 1},
        {x: 250, y: 4, t: 2}, {x: 260, y: 2, t: 1}, {x: 280, y: 0, t: 1}
    ],

    // 8. Time Machine
    [
        {x: 10, y: 0, t: 1}, {x: 20, y: 0, t: 2}, {x: 30, y: 0, t: 2},
        {x: 40, y: 0, t: 1}, {x: 40, y: 1, t: 2}, 
        ...
        {x: 160, y: 0, t: 8}, // ROBOT
        ...floorSpikes(170, 10), // Big jump required
        {x: 170, y: 2, t: 1}, {x: 185, y: 4, t: 1}, {x: 200, y: 2, t: 1}
    ],
    ...
    [
        ...
        {x: 120, y: 3, t: 3}, // SHIP
        ...floorSpikes(125, 30), // Don't touch ground
        {x: 140, y: 0, t: 1}, {x: 140, y: 9, t: 1},
        {x: 160, y: 1, t: 1}, {x: 160, y: 8, t: 1},
        {x: 180, y: 2, t: 1}, {x: 180, y: 7, t: 1},

        {x: 210, y: 0, t: 4}, // CUBE
        {x: 220, y: 0, t: 2}, {x: 221, y: 0, t: 2}, {x: 222, y: 0, t: 2},
        {x: 235, y: 2, t: 1}, {x: 250, y: 4, t: 1}, {x: 265, y: 0, t: 2}
    ],

    // 10. xStep (Demon Length)
    [
        {x: 10, y: 0, t: 1}, {x: 15, y: 1, t: 1}, {x: 20, y: 2, t: 1},
        ...
        {x: 160, y: 0, t: 8}, // ROBOT
        {x: 170, y: 0, t: 1}, {x: 180, y: 3, t: 1}, {x: 195, y: 5, t: 1},
        {x: 210, y: 0, t: 2}, {x: 212, y: 0, t: 2},
        
        {x: 230, y: 3, t: 3}, // SHIP END
        ...floorSpikes(235, 10),
        {x: 250, y: 5, t: 1}, {x: 260, y: 5, t: 1}, {x: 270, y: 5, t: 1}
    ]
];
...
function loadLevelData(index) {
    ...
    LEVELS[index].forEach(obj => {
        ...
        // NEW: If portal, make it touch the ground so it's unmissable
        if (obj.t >= 3 && obj.t <= 8) {
            newObj.y = 0;
            newObj.h = PHY.GROUND;
        }
...
function updatePhysics() {
    ...
    // --- GAMEMODE BEHAVIOR (JUMPS UNTOUCHED) ---
    ...
    gameState.objects.forEach(obj => {
        ...
        if (drawX > -50 && drawX < canvas.width + 50) {
            if (obj.type === 1) { // Block
                ...
                ctx.globalAlpha = 0.5;
                // Draw portal from y=0 to height
